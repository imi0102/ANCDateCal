...
import 'features/date_calculator/presentation/widgets/banner_ad_widget.dart';
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
                ANCDateCalculatorScreen(lmp: DateTime.now()),
                const PNCDateCalculatorScreen(),
              ],
            ),
          ),

          // 🔥 SINGLE BANNER AD (safe)
          const SafeArea(child: BannerAdWidget(adUnitId: AdIds.banner)),
        ],
      ),
    );
  }
